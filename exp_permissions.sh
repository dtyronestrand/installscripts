...
FILES_666[1]=$DIR/$SYSTEM_FOLDER/user/config/config.php 
FILES_666[2]=$DIR/$SYSTEM_FOLDER/config_bak.php
FILES_666[3]=$DIR/$SYSTEM_FOLDER/ee/*
FILES_666[4]=$DIR/themes/ee/*

DIRS_777[0]=$DIR/images/avatars/
...
DIRS_777[6]=$DIR/$SYSTEM_FOLDER/user/cache/
DIRS_777[7]=$DIR/$SYSTEM_FOLDER/ee/
DIRS_777[8]=$DIR/$SYSTEM_FOLDER/user/templates/
DIRS_777[9]=$DIR/themes/ee/
DIRS_777[10]=$DIR/themes/user/
